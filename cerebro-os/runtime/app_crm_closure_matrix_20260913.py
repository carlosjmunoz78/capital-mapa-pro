...
OBJECTIVES = {
    ...
    "APP_002_auth_rpc_security": "PARTIAL_LIVE_WRAPPERS_HARDENED_ROUTING_V17_DEPLOYED_APP_STILL_DIRECT_RPC_HTTP_E2E_AND_ADVISOR_WARNINGS_OPEN",
...
BLOCKERS = {
    "rpc_live_migration": {
        ...
        "pull_request": {
            ...
            "mergeable": True,
            "base": "main",
            "base_sha": "95106d8e792257f809033486b7025d81665ea83b",
    ...
    "supabase_security_advisor": {
        ...
        "status": "REVIEW_REQUIRED_NO_BLIND_BULK_FIX",
    },
    "cerebro_console": {
...
def assess() -> dict:
    ...
    return {
        ...
        "status": "APP_CRM_COMMUNICATIONS_CORE_GREEN_LIVE_APP_PRE_MIGRATION_SECURITY_ADVISOR_REVIEW_OPEN",
    }
