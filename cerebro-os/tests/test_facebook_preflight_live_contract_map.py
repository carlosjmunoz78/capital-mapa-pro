...
MODULE_PATH = ROOT / "runtime" / "facebook_preflight_live_contract_map.py"
spec = importlib.util.spec_from_file_location("facebook_preflight_live_contract_map", MODULE_PATH)
...
class FacebookPreflightLiveContractMapTests(unittest.TestCase):
    def test_all_expected_facebook_preflights_are_registered(self):
        self.assertEqual(set(module.LIVE_PREFLIGHT_MAP), {9531078, 9531133, 9533424, 9533987, 9533988, 9533976})

    def test_all_contracts_fail_closed_and_preserve_old(self):
        self.assertTrue(module.all_fail_closed())
        for scenario_id in module.LIVE_PREFLIGHT_MAP:
            item = module.get_live_contract(scenario_id)
    ...
    def test_link_contract_preserves_direct_read_no_publish_invariant(self):
        item = module.get_live_contract(9531078)
    ...
    def test_image_contract_requires_asset_and_http_evidence_without_publish(self):
        item = module.get_live_contract(9531133)
    ...
    def test_video_short_remains_human_review_evidence_capture(self):
        item = module.get_live_contract(9533424)
    ...
    def test_carousel_exact_live_bounds_are_preserved(self):
        item = module.get_live_contract(9533987)
    ...
    def test_long_video_exact_live_bounds_are_preserved(self):
        item = module.get_live_contract(9533988)
    ...
    def test_story_stays_queued_when_provider_is_not_connected(self):
        item = module.get_live_contract(9533976)
