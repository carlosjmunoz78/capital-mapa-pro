...
$TransportPatch = "browser-operator-local-fixture-v16"
        ...
        try {
            ...
            if ([bool]$execution.direct) {
                ...
                $localResult = [ordered]@{
                    ...
                    operator_observed_value = [string]$local.lab_operator_observed_value
                }
            }
            ...
            if ([string]$cmd.payload.action -in @("OPERATOR_CLICK","OPERATOR_TYPE","OPERATOR_SELECT","OPERATOR_READ")) {
                $expectedOperatorValue = switch ([string]$cmd.payload.action) {
                ...
                $ok = $ok -and
                    [string]$localResult.evidence_ref -ceq "LAB_OPERATOR_FIXTURE_VERIFIED" -and
                    [string]$localResult.operator_observed_value -ceq $expectedOperatorValue -and
                    -not [bool]$localResult.external_mutation_performed -and
                    -not [bool]$localResult.secret_value_included
            }
