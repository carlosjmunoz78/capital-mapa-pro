...
RECOVERY = WIN / "recovery_v1_5"
SHELL = ("INSTALL_AND_VERIFY.bat", "Install-CerebroBrowserMetadataRecovery.ps1",
         "ROLLBACK.bat", "README.txt")
PAYLOAD = {
...
if __name__ == "__main__":
    dest = ROOT.parent / ".cerebro-runtime" / "packages" / "CEREBRO_BROWSER_METADATA_RECOVERY_V1_5_0.zip"
