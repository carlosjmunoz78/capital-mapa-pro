...
REC=WIN/"recovery_v1_6_1"
SHELL=("INSTALL_AND_VERIFY.bat","ROLLBACK.bat","README.txt","Install-CerebroBrowserReplayGuardV161.ps1")
PAYLOAD={
...
def build(output:Path)->dict:
 ...
 return {"package_version":"1.6.1","service_version":"1.4.1","artifact":str(output),
...
if __name__=="__main__":
 destination=ROOT.parent/".cerebro-runtime"/"packages"/"CEREBRO_BROWSER_REPLAY_GUARD_V1_6_1.zip"
