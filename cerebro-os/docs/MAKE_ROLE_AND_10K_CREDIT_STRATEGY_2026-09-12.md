...
### USAR MAKE
1. Conectores SaaS que ya funcionan y reducen código de integración: Google Search Console, GA4, Meta/Instagram/Facebook, LinkedIn, YouTube, Notion, WordPress y equivalentes cuando el conector tenga mejor coste/fiabilidad que mantener código propio.
...
1. Transformaciones masivas, loops grandes o backfills históricos.
2. Scraping intensivo o crawling de miles de URLs.
3. Almacenamiento histórico pesado.
4. Entrenamiento, embeddings, OCR pesado, simulación o jobs largos.
5. Lógica de decisión, scoring estratégico, políticas o tribunal.
6. IA de pago dentro de Make cuando Python/TypeScript/local/model router pueda resolverlo con menor coste.
7. Duplicar source of truth de Supabase/CRM/Notion/GSC/GA4.
...
- WordPress -> webhooks/API para cambios, formularios, health y SEO técnico; no usar Make como CMS paralelo.
...
Los 10.000 créditos son un **presupuesto máximo útil**, no un objetivo de quemado. En módulos no-IA, Make factura normalmente 1 crédito por operación; los créditos no usados expiran al final del periodo. Por ello el objetivo es maximizar señal útil por crédito, no consumir 100% artificialmente.
...
4. Calcular el presupuesto mensual previsto y evitar rutas que excedan 10k.
5. Elegir uno a uno KEEP / WRAP / MIGRATE / QUARANTINE / RETIRE_CANDIDATE.
6. No activar colectores de competencia hasta verificar fuente, permisos/términos, contrato de datos, coste y destino.
7. Promover sólo con evidencia runtime, observabilidad y rollback.

## Resultado esperado
Make queda aprovechado donde tiene ventaja real: conectores, webhooks, SaaS y captura de señales. CEREBRO queda como sistema de decisión, almacenamiento contractual, inteligencia y gobierno. Esto conserva la inversión existente, reduce lock-in, usa los 10.000 créditos donde más valor generan y mantiene la arquitectura multiempresa preparada para crecer sin convertir Make en un cuello de botella.
