...
| 9528150 | Facebook 24h technical capture closure | inactive; datastore-only completion/idempotency chain | MIGRATE_TO_RUNTIME | Completion windows, partial-data isolation and idempotency are deterministic runtime concerns; preserve OLD for parity only. |
